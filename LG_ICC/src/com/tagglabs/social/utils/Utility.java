...
public class Utility {
    ...
    public static final String FB_REDIRECT_URL = "http://54.200.86.247:8084/lg_icc/index.sec";
    public static final String TWITTER_REDIRECT_URL = "http://54.200.86.247:8084/lg_icc/index.twt";
    ...
    public static Connection getConnection() throws Exception{
        if (conn == null || conn.isClosed() || !conn.isValid(10)){
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/lg_icc", "root", "root");    
        }
        return conn;
    }
}
